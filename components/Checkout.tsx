  ...
  if (!isAuthenticated) {
    return (
      <div className="py-20 flex flex-col items-center text-center animate-fade-in">
        <h2 className="text-2xl font-serif font-bold mb-6 text-gray-900 dark:text-white">Sign in to complete your order</h2>
          ...
          <section className="bg-white dark:bg-dark-card p-6 md:p-8 rounded-[2rem] border border-gray-100 dark:border-white/10 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {shippingOptions.map(option => (
                <label
                  key={option.id}
                  className={`relative flex items-center justify-between p-4 rounded-2xl border-2 cursor-pointer transition-all ${selectedShippingId === option.id
